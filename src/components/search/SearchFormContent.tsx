...
interface SearchFormContentProps {
  ...
  // Add onTextUpdate back if needed for audio/URL scraping results
...
export const SearchFormContent = ({ // Removed memo wrapper
  searchText,
  isProcessing,
  isScrapingProfiles,
  searchString,
  ...
  // --- Start: Logic moved from ContentTextarea ---
  ...
  return (
    <>
      ...
      <form onSubmit={onSubmit} className="space-y-6">
        ...
        {/* Action Buttons - Rendered using moved logic */}
...
}; // Add the missing closing brace for the component function
